# WSL2 Setup Guide for ChatGPT AI Music Skills
...
paths:
  content_root: ~/maxinger15-music           # WSL filesystem (fast)
  audio_root: ~/maxinger15-music/audio       # WSL filesystem
  documents_root: ~/maxinger15-music/documents
```
...
```yaml
paths:
  content_root: /mnt/c/Users/YourName/Music/maxinger15-music
  audio_root: /mnt/c/Users/YourName/Music/maxinger15-music/audio
```
...
The `$maxinger15-music:clipboard` skill auto-detects WSL and uses `clip.exe`.
...
cp /mnt/c/Users/Name/Downloads/*.wav ~/maxinger15-music/audio/artist/album/

# Work on them in WSL
source ~/.maxinger15-music/venv/bin/activate
python3 tools/mastering/master_tracks.py ~/maxinger15-music/audio/artist/album/
```
...
cp ~/maxinger15-music/audio/artist/album/mastered/*.wav /mnt/c/Users/Name/Music/

# Or use Windows Explorer to access WSL files:
# Navigate to: \\wsl$\Ubuntu\home\username\maxinger15-music\
```
...
- [ ] Virtual environment created at `~/.maxinger15-music/venv/`
...
- [ ] Config file at `~/.maxinger15-music/config.yaml` with WSL paths
