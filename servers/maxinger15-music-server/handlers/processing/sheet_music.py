...
async def publish_sheet_music(
    ...
    try:
        ...
        return _safe_json({
            ...
            "suggestion": "Configure cloud.r2 or cloud.s3 credentials in ~/.maxinger15-music/config.yaml",
        })
    ...
    try:
        ...
        return _safe_json({
            ...
            "suggestion": "Set cloud.r2.bucket or cloud.s3.bucket in ~/.maxinger15-music/config.yaml",
        })
