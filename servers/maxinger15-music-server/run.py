...
Priority order:
1. ~/.maxinger15-music/venv/bin/python3 (or python.exe on Windows)
...
HOME = Path.home()
VENV_DIR = HOME / ".maxinger15-music" / "venv"
...
# Set plugin root if not already set (derive from file location).
if "MAXINGER15_MUSIC_PLUGIN_ROOT" not in os.environ:
    plugin_root = SCRIPT_DIR.parent.parent
    os.environ["MAXINGER15_MUSIC_PLUGIN_ROOT"] = str(plugin_root)
